...
void bmp280_get_data(I2C_Handle *i2c, double *pres, double *temp) {
    ...
    */
    ...
    if (I2C_transfer(*i2c, &i2cTransaction)) {
    	...
    	// JTKJ: Laske mittausarvot i2c-viestin puskurista rxBuffer. Käyttäkää hyväksi harjoitustehtävän koodia..

    	// JTKJ: Convert the parsed raw data into temperature and pressure values
    	// JTKJ: Muunna rekisterin raakadata lämpötila- ja ilmanpainearvoiksi
